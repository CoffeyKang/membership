<form wire:submit.prevent="save" class="p-6">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div class="md:col-span-2">
            <label for="full_name" class="block text-sm font-medium text-gray-700">{{ __('messages.enter_full_name') }}</label>
            <input
                id="full_name"
                type="text"
        ...
        <!-- Phone Number -->
        <div>
            <label for="phone_number" class="block text-sm font-medium text-gray-700">{{ __('messages.enter_phone_number') }}</label>
            <input
                id="phone_number"
                type="tel"
    ...
    <div class="mt-6 flex items-center justify-end space-x-3">
        ...
        >
            {{ __('messages.back_to_member_list') }}
        </a>
        <button
            type="submit"
